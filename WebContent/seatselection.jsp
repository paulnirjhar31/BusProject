...
<div class="modal fade" id="myModal5" data-backdrop="static" role="dialog" aria-labelledby="myModalLabel" style="display: block;background-color: white;height: 320px;width: 950px;margin: auto;z-index: -50">   
<br/>
<div id="holder"> 
    <ul  id="place">
    </ul>    
</div>
<div style="float:left;float: left;margin-left: 30%;margin-right: auto;margin-top: 10px;"> 
<ul id="seatDescription">
  ...
  <div style="clear:both;width:100%;margin-left: 40%;margin-bottom: 15px;">
