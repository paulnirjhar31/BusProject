...
<!-- //for-mobile-apps -->
<link href="csspaymentsystem/style.css" rel="stylesheet" type="text/css" media="all" />
...
<body>
	<div class="main">
		<div class="container">
			...
			<script src="jspaymentsystem/easyResponsiveTabs.js" type="text/javascript"></script>
								...
								<div class="resp-tabs-container">
									<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
										<div class="payment-info">
											...
											<form action="/BusProject/SUCCESS" method="post">
												<div class="tab-for">				
													<h5>NAME ON CARD</h5>
